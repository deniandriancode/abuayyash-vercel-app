...
export default function Navbar() {
  ...
  return (
    <>
      ...
      { menuOpen && 
      <div className="w-fit bg-white mt-2 ps-3 pe-2 py-3 absolute z-[10] right-2 flex flex-col justify-center items-end text-right gap-1 md:hidden rounded border-[1px] border-[#b5b5b5]">
